const translations = {
    es: {
        ...
        fiverr_btn: "Contrátame en Fiverr",
    ...
    en: {
        ...
        about_text: "I am a Sound and Image Engineer from the University of Malaga. I am passionate about sound and music. I worked for a year on <a href='http://www.fiverr.com/s/GzZyve7' target='_blank' style='color:var(--accent-gold); text-decoration:underline;'>Fiverr</a> and composed the soundtrack for over 20 projects with a 5-star average and maximum client satisfaction. I have composed music across many genres. I also served as the university choir director for two years, where I greatly honed my musical and communicative skills.",
